...
pub macro T {
    ...
    [@ident] => {
    $crate::SyntaxKind::LIT_IDENT_TOKEN },
    ...
    [@string] => {
    $crate::SyntaxKind::LIT_STR_TOKEN },
    ...
    [@whitespace] => {
    $crate::SyntaxKind::WHITESPACE_TOKEN },
    [@unknown] => {
    $crate::SyntaxKind::UNKNOWN_TOKEN },
}
...
pub macro N {
    ...
    [BlockStmts] => {
    $crate::SyntaxKind::BLOCK_STMTS_NODE },
    [Block] => { $crate::SyntaxKind::BLOCK_NODE },
    [Stmt] => { $crate::SyntaxKind::STMT_NODE },
    [Name] => {
    $crate::SyntaxKind::NAME_NODE },
    [Visibility] => { $crate::SyntaxKind::VIS_NODE },
    [Mutability] => { $crate::SyntaxKind::MUTNESS_NODE },
    [ExprSpecifier] => {
    $crate::SyntaxKind::EXPR_SPEC_NODE },
    [TypeQualifier] => {
    $crate::SyntaxKind::TYPE_QUAL_NODE },
    [TypeSpecifier] => {
    $crate::SyntaxKind::TYPE_SPECIFIER_NODE },
    [Item] => { $crate::SyntaxKind::ITEM_NODE },
    [Annotations] => { $crate::SyntaxKind::ANNOTATIONS_NODE },
    [AbstractItem] => {
    $crate::SyntaxKind::ABSTRACT_ITEM_NODE },
    [ConstItem] => {
    $crate::SyntaxKind::CONST_ITEM_NODE },
    [EnumItem] => {
    $crate::SyntaxKind::ENUM_ITEM_NODE },
    [FnItem] => { $crate::SyntaxKind::FN_ITEM_NODE },
    [ImportItem] => { $crate::SyntaxKind::IMPORT_ITEM_NODE },
    [StructItem] => {
    $crate::SyntaxKind::STRUCT_ITEM_NODE },
    [TypeAliasItem] => {
    $crate::SyntaxKind::TYPE_ALIAS_ITEM_NODE },
    [Annotation] => {
    $crate::SyntaxKind::ANNOTATION_NODE },
    [GenericParamList] => {
    $crate::SyntaxKind::GENERIC_PARAM_LIST_NODE },
    [AbstractBody] => {
    $crate::SyntaxKind::ABSTRACT_BODY_NODE },
    [AbstractFnItem] => {
    $crate::SyntaxKind::ABSTRACT_FN_ITEM_NODE },
    [FnSignature] => {
    $crate::SyntaxKind::FN_SIGNATURE_NODE },
    [EnumBody] => {
    $crate::SyntaxKind::ENUM_BODY_NODE },
    [EnumVariant] => {
    $crate::SyntaxKind::ENUM_VARIANT_NODE },
    [EnumFn] => {
    $crate::SyntaxKind::ENUM_FN_NODE },
    [EnumVariantDataType] => {
    $crate::SyntaxKind::ENUM_VARIANT_DATA_TYPE_NODE },
    [FnInputs] => {
    $crate::SyntaxKind::FN_INPUTS_NODE },
    [FnInput] => {
    $crate::SyntaxKind::FN_INPUT_NODE },
    [FnInputModifiers] => {
    $crate::SyntaxKind::FN_INPUT_MODIFIERS_NODE },
    [FnInputModifierCapture] => {
    $crate::SyntaxKind::FN_INPUT_MODIFIER_CAPTURE_NODE },
    [FnInputModifierCaptureKind] =>
    { $crate::SyntaxKind::FN_INPUT_MODIFIER_CAPTURE_KIND_NODE },
    [ImportLeaf] => {
    $crate::SyntaxKind::IMPORT_LEAF_NODE },
    [ImportBranch] => {
    $crate::SyntaxKind::IMPORT_BRANCH_NODE },
    [ImportLeafRest] => {
    $crate::SyntaxKind::IMPORT_LEAF_REST_NODE },
    [ImportBranchSubtrees] => {
    $crate::SyntaxKind::IMPORT_BRANCH_SUBTREES_NODE },
    [StructBody] => {
    $crate::SyntaxKind::STRUCT_BODY_NODE },
    [StructField] => {
    $crate::SyntaxKind::STRUCT_FIELD_NODE },
    [StructFn] => {
    $crate::SyntaxKind::STRUCT_FN_NODE },
    [NameType] => {
    $crate::SyntaxKind::NAME_TYPE_NODE },
    [RefType] => {
    $crate::SyntaxKind::REF_TYPE_NODE },
    [BinaryType] => {
    $crate::SyntaxKind::BINARY_TYPE_NODE },
    [GenericArgList] => {
    $crate::SyntaxKind::GENERIC_ARG_LIST_NODE },
    [BinaryTypeOp] => {
    $crate::SyntaxKind::BINARY_TYPE_OP_NODE },
    [PrefixExpr] => {
    $crate::SyntaxKind::PREFIX_EXPR_NODE },
    [BinaryExpr] => {
    $crate::SyntaxKind::BINARY_EXPR_NODE },
    [CallExpr] => {
    $crate::SyntaxKind::CALL_EXPR_NODE },
    [LitExpr] => {
    $crate::SyntaxKind::LIT_EXPR_NODE },
    [ParenExpr] => {
    $crate::SyntaxKind::PAREN_EXPR_NODE },
    [ReturnExpr] => {
    $crate::SyntaxKind::RETURN_EXPR_NODE },
    [IfExpr] => {
    $crate::SyntaxKind::IF_EXPR_NODE },
    [DeferExpr] => {
    $crate::SyntaxKind::DEFER_EXPR_NODE },
    [StructExpr] => {
    $crate::SyntaxKind::STRUCT_EXPR_NODE },
    [LetExpr] => {
    $crate::SyntaxKind::LET_EXPR_NODE },
    [WhileExpr] => {
    $crate::SyntaxKind::WHILE_EXPR_NODE },
    [ForExpr] => {
    $crate::SyntaxKind::FOR_EXPR_NODE },
    [LoopExpr] => {
    $crate::SyntaxKind::LOOP_EXPR_NODE },
    [BreakExpr] => {
    $crate::SyntaxKind::BREAK_EXPR_NODE },
    [PrefixExprOp] => {
    $crate::SyntaxKind::PREFIX_EXPR_OP_NODE },
    [BinaryExprOp] => {
    $crate::SyntaxKind::BINARY_EXPR_OP_NODE },
    [CallExprArgs] => {
    $crate::SyntaxKind::CALL_EXPR_ARGS_NODE },
    [IfExprElseClause] => {
    $crate::SyntaxKind::IF_EXPR_ELSE_CLAUSE_NODE },
    [StructExprFields] => {
    $crate::SyntaxKind::STRUCT_EXPR_FIELDS_NODE },
    [StructExprField] => {
    $crate::SyntaxKind::STRUCT_EXPR_FIELD_NODE },
    [GenericArgs] => {
    $crate::SyntaxKind::GENERIC_ARGS_NODE },
    [GenericParams] => {
    $crate::SyntaxKind::GENERIC_PARAMS_NODE },
    [GenericParam] => {
    $crate::SyntaxKind::GENERIC_PARAM_NODE },
}
