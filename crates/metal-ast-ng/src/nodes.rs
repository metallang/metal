...
impl AstNode for ExprNode {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        match syntax.kind() {
            SyntaxKind::NAME_NODE => Some(ExprNode::NameNode(NameNode::cast(syntax)?)),
            SyntaxKind::PREFIX_EXPR_NODE => {
                Some(ExprNode::PrefixExprNode(PrefixExprNode::cast(syntax)?))
            }
            SyntaxKind::BINARY_EXPR_NODE => {
                Some(ExprNode::BinaryExprNode(BinaryExprNode::cast(syntax)?))
            }
            SyntaxKind::CALL_EXPR_NODE => {
                Some(ExprNode::CallExprNode(CallExprNode::cast(syntax)?))
            }
            SyntaxKind::LIT_EXPR_NODE => {
                Some(ExprNode::LitExprNode(LitExprNode::cast(syntax)?))
            }
            _ => None,
        }
    }
    fn syntax(&self) -> &SyntaxNode {
        match self {
            ExprNode::NameNode(it) => it.syntax(),
            ExprNode::PrefixExprNode(it) => it.syntax(),
            ExprNode::BinaryExprNode(it) => it.syntax(),
            ExprNode::CallExprNode(it) => it.syntax(),
            ExprNode::LitExprNode(it) => it.syntax(),
        }
    }
}
#[derive(Debug, Clone, PartialEq, Eq, Hash)]
...
pub enum ItemNode {
    /// See [ConstItemNode].
    ConstItemNode(ConstItemNode),
    /// See [EnumItemNode].
    EnumItemNode(EnumItemNode),
    /// See [ExprNode].
    ExprNode(ExprNode),
    /// See [FnItemNode].
    FnItemNode(FnItemNode),
    /// See [ImportItemNode].
    ImportItemNode(ImportItemNode),
    /// See [StructItemNode].
...
impl AstNode for ItemNode {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        match syntax.kind() {
            SyntaxKind::CONST_ITEM_NODE => {
                Some(ItemNode::ConstItemNode(ConstItemNode::cast(syntax)?))
            }
            SyntaxKind::ENUM_ITEM_NODE => {
                Some(ItemNode::EnumItemNode(EnumItemNode::cast(syntax)?))
            }
            SyntaxKind::EXPR_NODE => Some(ItemNode::ExprNode(ExprNode::cast(syntax)?)),
            SyntaxKind::FN_ITEM_NODE => {
                Some(ItemNode::FnItemNode(FnItemNode::cast(syntax)?))
            }
            SyntaxKind::IMPORT_ITEM_NODE => {
                Some(ItemNode::ImportItemNode(ImportItemNode::cast(syntax)?))
            }
            SyntaxKind::STRUCT_ITEM_NODE => {
                Some(ItemNode::StructItemNode(StructItemNode::cast(syntax)?))
            }
            _ => None,
        }
    }
    fn syntax(&self) -> &SyntaxNode {
        match self {
            ItemNode::ConstItemNode(it) => it.syntax(),
            ItemNode::EnumItemNode(it) => it.syntax(),
            ItemNode::ExprNode(it) => it.syntax(),
            ItemNode::FnItemNode(it) => it.syntax(),
            ItemNode::ImportItemNode(it) => it.syntax(),
            ItemNode::StructItemNode(it) => it.syntax(),
        }
    }
}
#[derive(Debug, Clone, PartialEq, Eq, Hash)]
...
impl AstNode for EnumBodyItemNode {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        match syntax.kind() {
            SyntaxKind::ENUM_VARIANT_NODE => {
                Some(EnumBodyItemNode::EnumVariantNode(EnumVariantNode::cast(syntax)?))
            }
            SyntaxKind::FN_ITEM_NODE => {
                Some(EnumBodyItemNode::FnItemNode(FnItemNode::cast(syntax)?))
            }
            _ => None,
        }
    }
    fn syntax(&self) -> &SyntaxNode {
        match self {
            EnumBodyItemNode::EnumVariantNode(it) => it.syntax(),
            EnumBodyItemNode::FnItemNode(it) => it.syntax(),
        }
    }
}
#[derive(Debug, Clone, PartialEq, Eq, Hash)]
...
pub enum ImportTreeNode {
    /// See [ImportLeafNode].
    ImportLeafNode(ImportLeafNode),
    /// See [ImportSegmentNode].
    ImportSegmentNode(ImportSegmentNode),
    /// See [ImportBranchNode].
    ImportBranchNode(ImportBranchNode),
}
impl AstNode for ImportTreeNode {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        match syntax.kind() {
            SyntaxKind::IMPORT_LEAF_NODE => {
                Some(ImportTreeNode::ImportLeafNode(ImportLeafNode::cast(syntax)?))
            }
            SyntaxKind::IMPORT_SEGMENT_NODE => {
                Some(ImportTreeNode::ImportSegmentNode(ImportSegmentNode::cast(syntax)?))
            }
            SyntaxKind::IMPORT_BRANCH_NODE => {
                Some(ImportTreeNode::ImportBranchNode(ImportBranchNode::cast(syntax)?))
            }
            _ => None,
        }
    }
    fn syntax(&self) -> &SyntaxNode {
        match self {
            ImportTreeNode::ImportLeafNode(it) => it.syntax(),
            ImportTreeNode::ImportSegmentNode(it) => it.syntax(),
            ImportTreeNode::ImportBranchNode(it) => it.syntax(),
        }
    }
}
#[derive(Debug, Clone, PartialEq, Eq, Hash)]
...
impl AstNode for StructBodyItemNode {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        match syntax.kind() {
            SyntaxKind::STRUCT_FIELD_NODE => {
                Some(StructBodyItemNode::StructFieldNode(StructFieldNode::cast(syntax)?))
            }
            SyntaxKind::FN_ITEM_NODE => {
                Some(StructBodyItemNode::FnItemNode(FnItemNode::cast(syntax)?))
            }
            _ => None,
        }
    }
    fn syntax(&self) -> &SyntaxNode {
        match self {
            StructBodyItemNode::StructFieldNode(it) => it.syntax(),
            StructBodyItemNode::FnItemNode(it) => it.syntax(),
        }
    }
}
#[derive(Debug, Clone, PartialEq, Eq, Hash)]
...
impl AstNode for LitExprNode {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        match syntax.kind() {
            SyntaxKind::NUM_LIT_NODE => {
                Some(LitExprNode::NumLitNode(NumLitNode::cast(syntax)?))
            }
            SyntaxKind::STR_LIT_NODE => {
                Some(LitExprNode::StrLitNode(StrLitNode::cast(syntax)?))
            }
            _ => None,
        }
    }
    fn syntax(&self) -> &SyntaxNode {
        match self {
            LitExprNode::NumLitNode(it) => it.syntax(),
            LitExprNode::StrLitNode(it) => it.syntax(),
        }
    }
}
#[derive(Debug, Clone, PartialEq, Eq, Hash)]
